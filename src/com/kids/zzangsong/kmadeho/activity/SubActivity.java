...
import com.kids.zzangsong.kmadeho.adapter.SubAdapter;
import com.kids.zzangsong.kmadeho.data.Ani_Sub_Data;
import com.kids.zzangsong.kmadeho.db.Favorite_DBopenHelper;
import com.kids.zzangsong.kmadeho.mediaplayer.ContinueMediaPlayer;
import com.kids.zzangsong.kmadeho.util.Crypto;
import com.kids.zzangsong.kmadeho.util.FadingActionBarHelper;
import com.kids.zzangsong.kmadeho.util.FadingActionBarHelperBase;
import com.kids.zzangsong.kmadeho.util.HangulUtil;
import com.kids.zzangsong.kmadeho.util.ImageLoader;
import com.kids.zzangsong.kmadeho.util.PreferenceUtil;
import com.kids.zzangsong.kmadeho.util.Utils;
import com.kids.zzangsong.kmadeho.videoplayer.CustomVideoPlayer;
...
//	mActionBar.setDisplayShowTitleEnabled(false);
	...
	public void setFadingActionBar() {
		...
		AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "w7hheunt");
		AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB, "ca-app-pub-4637651494513698/8261381766");
		AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB_FULL, "ca-app-pub-4637651494513698/9738114964");
...
//	  Custom Popup 시작
	    ...
	    CustomPopup.startCustomPopup(this, "w7hheunt");
		
		addBannerView();
	}
	
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("w7hheunt");
...
//        	adInfo.setTestMode(false);
	...
	public void create_mAdFloating(){
		...
		mAdFloating.setClientId("AX0005601");   
		// 할당받은 Slot 번호를 설정합니다.
...
//			menu.findItem(2).setVisible(false);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if(item.getItemId() == 0){
			...
			thumb = "http://m1.daumcdn.net/thumb/C138x78/U03/kids_infant/4FC438AE012E100054";
			list = new ArrayList<Ani_Sub_Data>();
			list.clear();
			load();
			edit.putInt("category_which", 0);
